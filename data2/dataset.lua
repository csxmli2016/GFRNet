...
--   print('image_count', 
   ...
   local imgAB, flip_flag
   imgAB, flip_flag=self:sampleHookTrain(imgpath)
   return imgAB, imgpath, flip_flag
end
...
--      print(class)
      local out, imgpath,flip_flag = self:getByClass(class)
      table.insert(dataTable, out)
      table.insert(scalarTable, class)
      table.insert(flipTabel,flip_flag)
...
--   print(table)
   ...
   return data, scalarLabels, samplePaths,flipTabel-- filePaths
end
